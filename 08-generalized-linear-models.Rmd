...
```{r logit-app, echo=FALSE, fig.cap="**Logistic regression web app** <https://dalejbarr.github.io/statistical-models-web-apps/logit-site/>"}
knitr::include_app("https://dalejbarr.github.io/logit-site/", "800px")
```
